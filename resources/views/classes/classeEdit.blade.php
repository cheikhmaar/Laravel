    ...
    <div class="row clearfix">
        <div class="col-md-9 col-md-offset-1">
            <div class="card">
                ...
                <div class="body">
                    <form id="form_validation" method="POST" action="/classeList/{{$classe->id}}">
                        @method('PATCH')
                        @csrf
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" class="form-control" value="{{ $classe->libelleClasse }}" name="libelleClasse" required>
